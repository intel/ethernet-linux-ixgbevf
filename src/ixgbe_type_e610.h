...
#define IXGBE_ACI_NVM_PKG_SKIPPED	BIT(0) /* used for command response */
...
IXGBE_CHECK_PARAM_LEN(ixgbe_aci_cmd_nvm_pkg_data);
...
#define IXGBE_ACI_NVM_PASS_COMP_VER_STR_LOWER_CODE	0xB
	u8 reserved;
	u8 transfer_flag;
#define IXGBE_ACI_NVM_PASS_COMP_TBL_START		0x1
#define IXGBE_ACI_NVM_PASS_COMP_TBL_MIDDLE		0x2
#define IXGBE_ACI_NVM_PASS_COMP_TBL_END			0x4
#define IXGBE_ACI_NVM_PASS_COMP_TBL_START_AND_END	0x5
	__le32 reserved1;
	__le32 addr_high;
	__le32 addr_low;
};

IXGBE_CHECK_PARAM_LEN(ixgbe_aci_cmd_nvm_pass_comp_tbl);
...
IXGBE_CHECK_VAR_LEN_STRUCT_LEN(12, ixgbe_aci_cmd_nvm_comp_tbl, u8);
